...
class CreateSupportTabsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('support_tabs', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->bigInteger('machine_parameter_id')->unsigned();
            $table->string('max_inc_v1');
            $table->string('max_inc_v2');
            $table->string('max_inc_v3');
            $table->string('max_inc_v4');
            $table->string('max_inc_v5');
            $table->string('max_inc_bp');
            $table->string('max_inc_fillp');
            $table->string('max_inc_pp1');
            $table->string('max_inc_pp2');
            $table->string('max_inc_pp3');
            ...
            $table->string('support_ccd')->comment = '0-YES, 1-NO';
    ...
    {
        Schema::dropIfExists('support_tabs');
    }
}
